<template>
    ...
    <div class="grid">
        <div id="topDepartamentos">
            <p class="topDepartamentos-titulo">Departamento</p>
        ...
        <div id="actividades">
            <div class="list-button">
                <button type="button"  v-on:click="CrearActividad()" ><b>Actividades</b></button>
            </div>
                  ...
                  <table id="table">
                      ...
                      <tbody>
                          <tr v-for="actividad in actividades" :key="actividad.IDactividad">
                              ...
                              <td>
                                  <router-link :to="{name: 'editactividades',params:{id:actividad.IDactividad}}">Editar</router-link> 
                              </td>
                          </tr>
                      </tbody>
                  </table>
        ...
        <div id="metas">
            <div class="list-button">
                <button type="button"  v-on:click="CrearMeta()" ><b>Metas</b></button>
            </div>
            <div class="list-table-container">
                <div class="list-table">
                  <table id="table">
                      <thead>
                        ...
                        <tbody>
                            <tr v-for="meta in metas" :key="meta.IDmetas">
                                <td>{{meta.nombre}}</td>
                                <td>
                                    <router-link :to="{name: 'editmetas',params:{id:meta.IDmetas}}">Editar</router-link> 
                                </td>
                            </tr>
                        </tbody>
                  </table>
...
export default{
  ...
  methods:{
    CrearActividad(){
        window.location.href='/actividades/'+cookies.getUserDep()
    },

    CrearMeta(){
         window.location.href='/metas/'+cookies.getUserDep()
    },
